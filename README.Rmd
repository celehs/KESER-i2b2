...
First, let's get the embedding from training data. Assume that you have training/testing CO file and freq file named as `CO_train`/`CO_test` and `freq_file_train`/`freq_file_test`.
