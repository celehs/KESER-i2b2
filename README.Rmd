...
Then, You can tune the dimensions on variable `dims`, each dimension may take 26-30 mins to run. 
...
The output of `get_eval_embed` is a list includes meta-data, embedding & evaluation results. The list will also be saved as `.Rdata`. In our testing case, each dimension value will take around **26** to **30** mins depending on actual data. 
